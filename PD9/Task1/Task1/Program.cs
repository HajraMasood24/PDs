...
namespace Task1
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            GradedCourse g1 = new GradedCourse("Programming Fundamentals", 70);
            GradedCourse g2 = new GradedCourse("Algorithms and Data Structures", 72);
            ...
            GradedCourse g3 = new GradedCourse("Statistical Analysis", 12);
            GradedCourse g4 = new GradedCourse("Research Findings Presentation", 10);
